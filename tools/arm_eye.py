...
class ArmEyeUI(object):
    ...
    def add_ur_frame(self, frame):
        ...
        self.ur_IP = tk.StringVar(value='192.168.1.101')
...
if __name__ == "__main__":
    mtx_path = os.path.join(root_path, 'cameras/images/realsense')
    ...
    with RealsenseSensor(align_to='color',use='color', insces_path=mtx_path) as camera:
        UI = ArmEyeUI(out_path, camera, mtx_path=mtx_path)
